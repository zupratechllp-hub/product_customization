...
app_include_css = ["/assets/product_customization/css/product_customization.css?v=20260905_03"]
app_include_js = [
    "/assets/product_customization/js/product_theme_loader_20260629_5.js?v=20260905_03",
